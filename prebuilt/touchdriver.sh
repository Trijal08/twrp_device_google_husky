...
then
	...
	insmod /vendor/lib/modules/goodix_brl_touch.ko
	insmod /vendor/lib/modules/goog_touch_interface.ko
fi
...
then
	...
	#cp /vendor/lib/modules/goodix_brl_touch.ko
	#cp /vendor/lib/modules/goog_touch_interface.ko
	#twrp unmount vendor
